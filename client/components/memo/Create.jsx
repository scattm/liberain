MemoCreate = React.createClass({
  ...
  render: function() {
    return (
      <div className="container text-center col-lg-10 col-lg-offset-2">
        ...
        <form className="form-horizontal col-md-6 text-left">
          <fieldset>
            <legend className="text-center">Live, Love and Laugh</legend>
